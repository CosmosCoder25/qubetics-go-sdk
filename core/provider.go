...
import (
	...
	v2 "github.com/qubetics/qubetics-blockchain/v2/x/provider/types/v2"
)

const (
	// gRPC methods for querying provider information
	methodQueryProvider  = "/qubetics.provider.v2.QueryService/QueryProvider"  // Retrieve details of a specific provider
	methodQueryProviders = "/qubetics.provider.v2.QueryService/QueryProviders" // Retrieve a list of providers with optional filtering
)
