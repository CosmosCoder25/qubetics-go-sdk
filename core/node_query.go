...
const (
	...
	methodQueryNode         = "/qubetics.node.v3.QueryService/QueryNode"         // Retrieve details of a specific node
	methodQueryNodes        = "/qubetics.node.v3.QueryService/QueryNodes"        // Retrieve a list of nodes with optional filtering
	methodQueryNodesForPlan = "/qubetics.node.v3.QueryService/QueryNodesForPlan" // Retrieve nodes associated with a specific plan
)
