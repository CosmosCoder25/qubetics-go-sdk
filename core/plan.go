...
const (
	...
	methodQueryPlan             = "/qubetics.plan.v3.QueryService/QueryPlan"             // Retrieve details of a specific plan
	methodQueryPlans            = "/qubetics.plan.v3.QueryService/QueryPlans"            // Retrieve a list of plans
	methodQueryPlansForProvider = "/qubetics.plan.v3.QueryService/QueryPlansForProvider" // Retrieve plans associated with a specific provider
)
