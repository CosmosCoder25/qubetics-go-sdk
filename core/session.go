...
const (
	...
	methodQuerySession                           = "/qubetics.session.v3.QueryService/QuerySession"                 // Retrieve details of a specific session
	methodQuerySessions                          = "/qubetics.session.v3.QueryService/QuerySessions"                // Retrieve a list of sessions with pagination
	methodQuerySessionsForAccount                = "/qubetics.session.v3.QueryService/QuerySessionsForAccount"      // Retrieve sessions associated with a specific account
	methodQuerySessionsForNode                   = "/qubetics.session.v3.QueryService/QuerySessionsForNode"         // Retrieve sessions associated with a specific node
	methodQuerySessionsForSubscription           = "/qubetics.session.v3.QueryService/QuerySessionsForSubscription" // Retrieve sessions associated with a specific subscription
	methodQuerySessionsForSubscriptionAllocation = "/qubetics.session.v3.QueryService/QuerySessionsForAllocation"   // Retrieve sessions for a subscription and account
)
...
// Returns the sessions, pagination details, and any error encountered.
func (c *Client) SessionsForNode(ctx context.Context, nodeAddr qubetics.NodeAddress, pageReq *query.PageRequest) (res []v3.Session, pageRes *query.PageResponse, err error) {
	var (
